...
from app.schemas.crm_provider import CRMProviderResponse, CRMProvidersResponse
from app.routers.crm import save_connection
from app.services.crm_registry import CRMRegistryEntry, list_crm_registry
from app.services.oauth_service import OAuthService
from app.services.token_service import TokenService


router = APIRouter(prefix="/api/crm/auth", tags=["crm-auth"])
alias_router = APIRouter(prefix="/api/crm", tags=["crm-auth"])
